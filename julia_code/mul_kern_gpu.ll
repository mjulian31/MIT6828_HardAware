...
@__static_shmem_291 = internal unnamed_addr addrspace(3) global [1056 x float] zeroinitializer, align 32
@__static_shmem_292 = internal unnamed_addr addrspace(3) global [1056 x float] zeroinitializer, align 32
...
L553:                                             ; preds = %L553, %L329
  ...
  %30 = getelementptr inbounds [1056 x float], [1056 x float] addrspace(3)* @__static_shmem_291, i64 0, i64 %29
  %31 = load float, float addrspace(3)* %30, align 4
  %32 = add nsw i64 %94, %value_phi15
  %33 = getelementptr inbounds [1056 x float], [1056 x float] addrspace(3)* @__static_shmem_292, i64 0, i64 %32
  ...
  %38 = getelementptr inbounds [1056 x float], [1056 x float] addrspace(3)* @__static_shmem_291, i64 0, i64 %37
  %39 = load float, float addrspace(3)* %38, align 4
  %40 = add nuw i64 %83, %value_phi15
  %41 = getelementptr inbounds [1056 x float], [1056 x float] addrspace(3)* @__static_shmem_292, i64 0, i64 %40
...
L329.preheader:                                   ; preds = %pass5
  ...
  %85 = getelementptr inbounds [1056 x float], [1056 x float] addrspace(3)* @__static_shmem_291, i64 0, i64 %84
  ...
  %89 = or i64 %58, %64
  %90 = mul i64 %89, %88
  %91 = getelementptr inbounds [1056 x float], [1056 x float] addrspace(3)* @__static_shmem_292, i64 0, i64 %84
