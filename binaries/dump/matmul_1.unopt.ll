...
; │││││││└
         %130 = call fastcc double @jl_llvmcall14(i8 addrspace(1)* %38, i64 %129), !dbg !305
; ││││└└└
...
; │││││││└
         call fastcc void @jl_llvmcall15(i8 addrspace(3)* %84, double %130, i64 %137), !dbg !338
; ││││└└└
...
; │││││││└
         call fastcc void @jl_llvmcall22(i8 addrspace(3)* %84, double 0.000000e+00, i64 %144), !dbg !367
; ││││└└└
; ││││ @ /home/local/.julia/packages/CUDA/BIYoG/src/device/array.jl:87 within `arrayset'
...
; │││││││└
         %173 = call fastcc double @jl_llvmcall16(i8 addrspace(1)* %39, i64 %172), !dbg !416
; ││││└└└
...
; │││││││└
         call fastcc void @jl_llvmcall17(i8 addrspace(3)* %87, double %173, i64 %180), !dbg !441
; ││││└└└
; ││││ @ /home/local/.julia/packages/CUDA/BIYoG/src/device/array.jl:87 within `arrayset'
...
; │││││││└
         call fastcc void @jl_llvmcall21(i8 addrspace(3)* %87, double 0.000000e+00, i64 %187), !dbg !468
; ││││└└└
; ││││ @ /home/local/.julia/packages/CUDA/BIYoG/src/device/array.jl:87 within `arrayset'
...
; │││││││└
         %195 = call fastcc double @jl_llvmcall18(i8 addrspace(3)* %84, i64 %194), !dbg !500
; ││││└└└
...
; │││││││└
         %203 = call fastcc double @jl_llvmcall19(i8 addrspace(3)* %87, i64 %202), !dbg !500
; ││││└└└
...
; │││││││└
         call fastcc void @jl_llvmcall20(i8 addrspace(1)* %37, double %value_phi20, i64 %251), !dbg !566
; ││││└└└
; ││││ @ /home/local/.julia/packages/CUDA/BIYoG/src/device/array.jl:87 within `arrayset'
...
!43 = distinct !DISubprogram(name: "coalesced_matmul_kernel!", linkageName: "julia_coalesced_matmul_kernel!_3147", scope: null, file: !3, line: 88, type: !44, scopeLine: 88, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
...
!308 = !DIFile(filename: "/home/local/.julia/packages/LLVM/dVU7J/src/interop/pointer.jl", directory: ".")
...
!477 = !DIFile(filename: "/home/local/.julia/packages/CUDA/BIYoG/src/device/intrinsics/synchronization.jl", directory: ".")
...
!601 = distinct !DISubprogram(name: "report_exception", linkageName: "julia_report_exception_3593", scope: null, file: !15, line: 39, type: !44, scopeLine: 39, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !14, retainedNodes: !4)
...
!606 = !DIFile(filename: "/home/local/.julia/packages/CUDA/BIYoG/src/device/intrinsics/output.jl", directory: ".")
...
!611 = distinct !DISubprogram(name: "signal_exception", linkageName: "julia_signal_exception_3667", scope: null, file: !15, line: 25, type: !44, scopeLine: 25, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !23, retainedNodes: !4)
