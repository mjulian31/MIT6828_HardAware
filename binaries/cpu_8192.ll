...
define nonnull %jl_value_t* @"japi1_mul_tile!_1274"(%jl_value_t*, %jl_value_t**, i32) #0 {
top:
  ...
  %6 = call %jl_value_t*** inttoptr (i64 1348453735280 to %jl_value_t*** ()*)() #7
...
L20:                                              ; preds = %top
  ...
  store %jl_value_t* inttoptr (i64 130956848846608 to %jl_value_t*), %jl_value_t** %40
  ...
  store %jl_value_t* inttoptr (i64 130956766949472 to %jl_value_t*), %jl_value_t** %43
  %44 = getelementptr %jl_value_t*, %jl_value_t** %3, i32 1
  store %jl_value_t* inttoptr (i64 130956848222304 to %jl_value_t*), %jl_value_t** %44
  %45 = getelementptr %jl_value_t*, %jl_value_t** %3, i32 2
  store %jl_value_t* %38, %jl_value_t** %45
  %46 = call nonnull %jl_value_t* @jl_invoke(%jl_value_t* inttoptr (i64 130956854546320 to %jl_value_t*), %jl_value_t** %3, i32 3, %jl_value_t* inttoptr (i64 130956854545792 to %jl_value_t*))
...
L34:                                              ; preds = %L18
  %48 = call i32 inttoptr (i64 130957246176688 to i32 ()*)()
  %49 = icmp ne i32 %48, 0
  br label %L38
...
L38:                                              ; preds = %L34, %L18
  ...
  store %jl_value_t* inttoptr (i64 130939359726704 to %jl_value_t*), %jl_value_t** %53
...
L54:                                              ; preds = %L38
  ...
  store %jl_value_t* inttoptr (i64 130956849757168 to %jl_value_t*), %jl_value_t** %58
...
L59:                                              ; preds = %L38
  ...
  %65 = call nonnull %jl_value_t* @jl_invoke(%jl_value_t* inttoptr (i64 130956905302384 to %jl_value_t*), %jl_value_t** %3, i32 1, %jl_value_t* inttoptr (i64 130940053186512 to %jl_value_t*))
  br label %L60
...
L60:                                              ; preds = %L59, %L54
  ...
  ret %jl_value_t* inttoptr (i64 130956848565200 to %jl_value_t*)
}

; Function Attrs: nounwind readnone speculatable
declare double @llvm.trunc.f64(double) #1

declare nonnull %jl_value_t* @j_getindex_1275(%jl_value_t* readonly, i64)
