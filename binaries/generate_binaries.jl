...
run(`/usr/local/cuda-11.1/bin/nvcc --gpu-architecture=sm_60 --device-c matmul_gpu.ptx`)
run(`/usr/local/cuda-11.1/bin/nvcc --gpu-architecture=sm_60 -dc -o matmul_gpu main_gpu.cu matmul_gpu.o`)
